...
declare -A REGISTRY=(
  ...
  [lfm-8b]="$MODELS_DIR/LFM2.5-8B-A1B-GGUF/LFM2.5-8B-A1B-Q6_K.gguf|8080|65536|99|--alias lfm2.5-8b-a1b --temp 0.2 --top-k 80 --repeat-penalty 1.05|draft=$MODELS_DIR/LFM2.5-1.2B-Instruct-GGUF/LFM2.5-1.2B-Instruct-Q4_K_M.gguf" # --chat-template-kwargs {\"keep_past_thinking\":true}
